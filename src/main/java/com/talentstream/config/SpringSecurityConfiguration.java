...
public class SpringSecurityConfiguration {
	...
	public SpringSecurityConfiguration(UserDetailsService myUserDetailsService,JwtRequestFilter jwtRequestFilter ) {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf(AbstractHttpConfigurer::disable)
				...
				.antMatchers("/resume/retryResumeRegistration","/resume/pdf/{id}", "/applicant/getApplicantById/{id}", "/send-message", "/health",
						...
						"/v3/api-docs/**", "/swagger-resources/**", "/webjars/**","/getAllJobs","/applicant/refreshToken")
				.permitAll()
